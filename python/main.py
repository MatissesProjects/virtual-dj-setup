...
latest_data = {"vibe": "IDLE", "authority": "AI", "rms": -60, "centroid": 0}
...
def main():
    ...
    try:
        print("System Live! C# Engine + Python Brain + Vue UI Connected.")
        while True:
            ...
            if features:
                ...
                latest_data["rms"] = 20 * (features['rms'] + 0.000001) # Simple dB-ish conversion
                ...
                if features['authority'] == 1:
                    ...
                    print(f"\r[SHADOW MODE] Logging... RMS: {features['rms']:.4f} | Auth: {authority}    ", end="")
                else:
